...
Getting the relevant data is a part of the challenge. To get started, we provided some data from  Google Trends API, and a tutorial showing how to access this API from R. The Google Trends data shows organic search interest for different keywords.
...
Dates of recent major emergencies can be found in `data\emergencies.csv`
